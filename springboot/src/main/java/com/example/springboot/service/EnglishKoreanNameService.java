...
public class EnglishKoreanNameService {
    ...
    static {
        ...
        String[][] pinyinData = {
            ...
            {"NEN", "\uB10C"}, {"NENG", "\uB11D"}, {"NI", "\uB2C8"}, {"NIAN", "\uB2CC"}, {"NIANG", "\uB0AD"},
            {"NIAO", "\uB098\uC624"}, {"NIE", "\uB2CC"}, {"NIN", "\uB2CC"}, {"NING", "\uB2CC"}, {"NIU", "\uB274"},
            {"NONG", "\uB18D"}, {"NOU", "\uB178\uC6B0"}, {"NU", "\uB204"}, {"NUAN", "\uB09C"}, {"NUO", "\uB108"},
            {"OU", "\uC624\uC6B0"}, {"PA", "\uD30C"}, {"PAI", "\uD30C\uC774"}, {"PAN", "\uD310"}, {"PANG", "\uBC29"},
            {"PAO", "\uD30C\uC624"}, {"PEI", "\uD398\uC774"}, {"PEN", "\uD338"}, {"PENG", "\uD351"}, {"PI", "\uD33C"},
            {"PIAN", "\uD3B8"}, {"PIAO", "\uD45C"}, {"PIE", "\uBCC4"}, {"PIN", "\uBE48"}, {"PING", "\uD3C9"},
            {"PO", "\uD30C"}, {"POU", "\uBD80"}, {"PU", "\uD3EC"}, {"QI", "\uCE58"}, {"QIA", "\uCC28"},
            {"QIAN", "\uCCB8"}, {"QIANG", "\uCC3D"}, {"QIAO", "\uCC28\uC624"}, {"QIE", "\uCC28\uC5D0"}, {"QIN", "\uCC28\uC778"},
            {"QING", "\uCE6D"}, {"QIONG", "\uCDA9"}, {"QIU", "\uCD94"}, {"QU", "\uCD94"}, {"QUAN", "\uCD3D"},
            {"QUE", "\uCD14"}, {"QUN", "\uCD98"}, {"RAN", "\uB780"}, {"RANG", "\uB791"}, {"RAO", "\uB77C\uC624"},
            {"RE", "\uB7EC"}, {"REN", "\uB720"}, {"RENG", "\uB801"}, {"RI", "\uB9AC"}, {"RONG", "\uB821"},
            ...
            {"TE", "\uD130"}, {"TENG", "\uD145"}, {"TI", "\uD0F0"}, {"TIAN", "\uD2F0\uC548"}, {"TIAO", "\uD2F0\uC544\uC624"},
            ...
            {"XING", "\uC2F1"}, {"XIONG", "\uC211"}, {"XIU", "\uC210"}, {"XU", "\uC2DC"}, {"XUAN", "\uC2DC\uC548"},
